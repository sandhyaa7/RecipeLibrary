...
import com.recipe.auth.CognitoJWTParser;
import com.recipe.auth.CognitoTokenHeader;
import com.recipe.auth.Keys;
import com.recipe.auth.TokenResponse;
import com.recipe.util.PropertiesLoader;
import com.recipe.auth.*;
...
public class Authorization extends HttpServlet implements PropertiesLoader {
